...
{
    /// <summary>
    /// An exception raised when an attempt is made to manipulate an object in a locked container
    /// </summary>
    public class LockedException : ApplicationException
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the LockedException class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the LockedException class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the LockedException class with serialized data.
        /// </summary>
