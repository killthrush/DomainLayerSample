...
{
    /// <summary>
    /// An exception raised when we try and do something really outside the bounds of reality.
    /// </summary>
    public class LawsOfPhysicsViolationException : ApplicationException
    {
        /// <summary>
        /// Initializes a new instance of the StateException class.
        /// </summary>
        public LawsOfPhysicsViolationException()
        {
        }
        ...
        public LawsOfPhysicsViolationException(string message) : base(message)
        {
        }
        ...
        public LawsOfPhysicsViolationException(string message, Exception innerException) : base(message, innerException)
        {
        }

        /// <summary>
        /// Initializes a new instance of the StateException class with serialized data.
        /// </summary>
        ...
        protected LawsOfPhysicsViolationException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}
